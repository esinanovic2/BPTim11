		...
		<body>
			<div class="container">
				...
				<form:form class="form-horizontal" method="post"
					modelAttribute="korisnikForm" action="${korisnikActionUrl}">
					...
					<spring:bind path="ime">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<div class="col-sm-10">
								<form:input path="ime" type="text" class="form-control "
					...
					<spring:bind path="prezime">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<div class="col-sm-10">
								<form:input path="prezime" class="form-control" id="prezime"
									placeholder="Prezime" />
					...
					<spring:bind path="korisnickoIme">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<div class="col-sm-10">
								<form:input path="korisnickoIme" type="text"
									class="form-control" id="korisnickoIme"
					...
					<spring:bind path="uloga">
						<form:input type="hidden" path="uloga" class="form-control"
							id="uloga" value="${uloga}" />
					</spring:bind>
